...
const Cart = (props) => {
  ...
  const didSubmitContent = <React.Fragment><p>Successfully sent your order!</p><button className={classes['button--alt']} onClick={props.onHideCart}>Close</button></React.Fragment>
